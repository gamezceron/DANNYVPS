...
while true; do
  ...
  echo "5. Ver conectados en el puerto 442"
  echo "6. Salir"
  ...
  case $opcion in
    ...
    2)
     ...
     3)
      ...
      ;;
      5)
      PSIPHON_PORT_442=$(sudo netstat -tn | awk '$4 ~ /:442$/ {print $5}' | cut -d: -f1 | sort | uniq -c | wc -l)
      echo "CONEXIONES EN EL PUERTO 442 DE PSIPHON: $PSIPHON_PORT_442"
      ;;
      6)
